...
// Define the middleware. It takes a single argument: the cls namespace to use.
// If none is passed a default namespace is used.
module.exports = function cidMiddleware(namespace) {
